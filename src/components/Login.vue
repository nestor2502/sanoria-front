                ...
                <div class="card-body">
                    ...
                    <form >
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Name" v-model="dataObj.username">
                        </div>
						<div class="input-group">
                        ...
                        <div class="p-t-30">
                            <button class="btn btn--radius btn--green" type="button"  @click="handleSave" >Login
...
/* ==========================================================================
  ...
  *, *:before, *:after {
  ...
  .card-2 .card-heading {
    background: url("../assets/bg-heading-02.jpg") top left/cover no-repeat;
    width: 29.1%;
    display: table-cell;
  }
